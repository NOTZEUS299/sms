      ...
      <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-lg">
        <form onSubmit={handleSubmit(addData)} method='post'>
          ...
          <div className="flex justify-evenly">
            ...
            <button
              type="submit"
              className="px-14 py-2 text-white rounded-md font-semibold bg-gradient-to-r from-orange-400 to-red-500 hover:from-blue-500 hover:to-red-600 focus:outline-none transition duration-200"
            >
              Apply
            </button>
          </div>
